...
public class KeyStorage implements IMinecraft {
    ...
    private static void putMappings() {
        ...
        keyMap.put("M4", GLFW.GLFW_MOUSE_BUTTON_4);
        keyMap.put("M5", GLFW.GLFW_MOUSE_BUTTON_5);
        keyMap.put("MB4", GLFW.GLFW_MOUSE_BUTTON_4);
        keyMap.put("MB5", GLFW.GLFW_MOUSE_BUTTON_5);
        keyMap.put("MOUSE3", GLFW.GLFW_MOUSE_BUTTON_MIDDLE);
        keyMap.put("MOUSE4", GLFW.GLFW_MOUSE_BUTTON_4);
        keyMap.put("MOUSE5", GLFW.GLFW_MOUSE_BUTTON_5);
        keyMap.put("MOUSE6", GLFW.GLFW_MOUSE_BUTTON_6);
        keyMap.put("MOUSE7", GLFW.GLFW_MOUSE_BUTTON_7);
        keyMap.put("MOUSE8", GLFW.GLFW_MOUSE_BUTTON_8);
    ...
    private static void reverseMappings() {
        for (Map.Entry<String, Integer> entry : keyMap.entrySet()) {
            ...
            if (name.equals("M4") || name.equals("M5") || name.equals("MB4") || name.equals("MB5")) {
                continue;
            }
            reverseKeyMap.put(entry.getValue(), name);
        }
    }
}
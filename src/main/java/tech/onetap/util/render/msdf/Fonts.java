...
public class Fonts {
    ...
    public static final Supplier<MsdfFont> MOONWARD_ICONS = Suppliers.memoize(() -> MsdfFont.builder().atlas("moonward_icons").data("moonward_icons").build());
    public static final Supplier<MsdfFont> CELESTIAL = Suppliers.memoize(() -> MsdfFont.builder().atlas("celestial").data("celestial").build());
    ...
    public static final Supplier<MsdfFont> TARGET = Suppliers.memoize(() -> MsdfFont.builder().atlas("target").data("target").build());
}
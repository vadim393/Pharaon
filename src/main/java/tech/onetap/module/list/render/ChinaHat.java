...
public class ChinaHat extends Module {
    ...
    public final BooleanSetting dualThemeGradient = new BooleanSetting("Два цвета темы", false);
    ...
    public boolean useDualThemeGradient() {
        return dualThemeGradient.getValue();
    }
}

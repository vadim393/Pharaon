...
public class ElytraMotion extends Module {
    ...
    private final BooleanSetting noKnockback = new BooleanSetting("No Knockback", true);

    public boolean isNoKnockbackEnabled() {
        return this.isEnabled() && this.noKnockback.getValue();
    }
